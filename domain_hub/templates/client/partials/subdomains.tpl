                            ...
                            <table class="table table-striped table-hover cf-subdomain-table">
                                <thead class="table-dark">
                                    ...
                                    foreach($existing as $e):
                                        ...
                                        $isServerHold = ($statusLower === 'suspended');
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="<?php echo cfclient_lang('cfclient.subdomains.table.status', '状态', [], true); ?>">
                                            ...
                                            <?php if ($isServerHold): ?>
                                                <span class="badge bg-danger">
                                                    <i class="fas fa-lock"></i> <?php echo cfclient_lang('cfclient.subdomains.status.server_hold', 'ServerHold', [], true); ?>
                                                </span>
                                            <?php elseif ($isDelegatedStatus): ?>
                                        ...
                                        <td data-label="<?php echo cfclient_lang('cfclient.subdomains.table.actions', '操作', [], true); ?>">
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <?php endif; ?>
                                                <?php if($rootInMaintenance || $pendingDelete || $disableNsManagement || $rootNsDisabled || $isServerHold): ?>
                                            ...
                                            ?>
                                            <?php if ($shouldRenderRenewButton && !$pendingDelete && !$isServerHold && !($inRedemptionWindow && $redemptionModeSetting !== 'auto_charge')): ?>
                                            <?php
